...
const BuyNowModal = ({ addressInfo, setAddressInfo, buyNowFunction }) => {
    ...
    return (
        <>
            ...
            <Dialog open={open} handler={handleOpen} className="bg-gradient-to-br from-pink-200 via-red-100 to-orange-100">
                <DialogBody className="p-6">
                    <div className="mb-3">
                        <input
                            ...
                            className="bg-white border border-orange-300 px-4 py-2 w-full rounded-md outline-none text-gray-800 placeholder-pink-400 shadow-sm focus:ring-2 focus:ring-pink-300"
                        />
                    </div>
                    <div className="mb-3">
                        <input
