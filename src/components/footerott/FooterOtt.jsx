...
const FooterOtt = () => {
    return (
        <footer className="bg-blue-700 text-black py-10 px-5">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <h5 className="text-xl font-semibold">Premium_Shop_Nepal</h5>
                    ...
                    <p className="mt-2 text-black">Email or Chat with us for any assistance.</p>
            ...
            <div className="mt-8 flex flex-col md:flex-row justify-between items-center border-t border-gray-700 pt-5">
                ...
                <div className="flex items-center space-x-2">
                    <label htmlFor="currency" className="text-black">Show prices in</label>
                ...
                <div className="flex flex-col md:flex-row items-center mt-5 md:mt-0 space-y-2 md:space-y-0 md:space-x-4">
                    <h5 className="text-black">Secure Checkout Guarantee With</h5>
