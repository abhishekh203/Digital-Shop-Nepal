        ...
        <section>
            <div className="container mx-auto px-5 py-10 md:py-14">
                ...
                <Slider {...settings}>
                    {/* Netflix */}
                    <div className="p-4">
                        <div className="border-2 border-red-600 bg-red-100 shadow-lg hover:shadow-red-500/50 hover:shadow-xl transform hover:scale-105 transition-transform duration-300 ease-out px-4 py-6 rounded-lg">
                            <img 
                                src={icons.netflix} 
                                alt="Netflix" 
                                className="w-24 h-24 object-contain mx-auto mb-4"
                            />
                            <h2 className="title-font font-bold text-xl text-red-700">Netflix</h2>
                    ...
                    {/* Prime Video */}
                    <div className="p-4">
                        <div className="border-2 border-blue-600 bg-blue-100 shadow-lg hover:shadow-blue-500/50 hover:shadow-xl transform hover:scale-105 transition-transform duration-300 ease-out px-4 py-6 rounded-lg">
                            <img 
                                src={icons.prime} 
                                alt="Prime Video" 
                                className="w-24 h-24 object-contain mx-auto mb-4"
                            />
                            <h2 className="title-font font-bold text-xl text-blue-700">Prime Video</h2>
                            <p className="leading-relaxed text-gray-800">
                    ...
                    {/* Spotify */}
                    <div className="p-4">
                        <div className="border-2 border-green-600 bg-green-100 shadow-lg hover:shadow-green-500/50 hover:shadow-xl transform hover:scale-105 transition-transform duration-300 ease-out px-4 py-6 rounded-lg">
                            <img 
                                src={icons.spotify} 
                                alt="Spotify" 
                                className="w-24 h-24 object-contain mx-auto mb-4"
                            />
                            <h2 className="title-font font-bold text-xl text-green-700">Spotify</h2>
                            <p className="leading-relaxed text-gray-800">
                    ...
                    <div className="p-4">
                        <div className="border-2 border-red-600 bg-red-100 shadow-lg hover:shadow-red-500/50 hover:shadow-xl transform hover:scale-105 transition-transform duration-300 ease-out px-4 py-6 rounded-lg">
                            <img 
                                ...
                                className="w-24 h-24 object-contain mx-auto mb-4"
                            />
                            <h2 className="title-font font-bold text-xl text-red-700">YouTube Premium</h2>
                            <p className="leading-relaxed text-gray-800">
