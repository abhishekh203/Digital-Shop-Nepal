...
const OTTSubscriptionInfo = () => {
    return (
        <section className="text-gray-800 body-font bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 py-12">
            <div className="container mx-auto px-5">
                {/* Header Section */}
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-wider">
                        Who We Are?
                    </h1>
                ...
                <div className="flex flex-col lg:flex-row justify-center items-center gap-10 bg-white text-gray-800 rounded-lg py-8 px-6 shadow-lg">
