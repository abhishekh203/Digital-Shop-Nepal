...
const UpdateProductPage = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-800 to-gray-900">
            {loading && <Loader />}
            <div className="bg-white px-8 py-8 border border-gray-300 rounded-lg shadow-lg max-w-lg w-full transition-transform transform hover:scale-105 duration-300 hover:bg-pink-50 hover:border-pink-300">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        type='button'
                        className='bg-green-500 hover:bg-green-600 w-full text-white text-center py-3 font-bold rounded-md transition-transform transform hover:scale-105 duration-300'
                    >
                        Update Product
                    </button>
                </div>
