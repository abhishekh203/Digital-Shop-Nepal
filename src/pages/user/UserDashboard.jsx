    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top">
                    {/* main */}
                    <div className="bg-green-50 py-5 rounded-xl border border-green-100 shadow-lg">
                        {/* image */}
                ...
                <div className="bottom mt-6">
                    ...
                    <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                        ...
                        {getAllOrder.filter((obj) => obj.userid === user?.uid).map((order, index) => (
                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-green-100 bg-green-50 md:flex-row shadow-lg">
                                {/* main 3 */}
