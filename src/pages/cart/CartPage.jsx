...
const CartPage = () => {
    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 max-w-7xl lg:px-0 bg-gray-100 min-h-screen py-8">
                                ...
                                {cartItems.length > 0 ? (
                                    <>
                                        {cartItems.map((item, index) => {
                                            ...
                                            return (
                                                <li key={index} className="flex py-6 items-center bg-gray-50 rounded-lg mb-4 shadow-sm">
